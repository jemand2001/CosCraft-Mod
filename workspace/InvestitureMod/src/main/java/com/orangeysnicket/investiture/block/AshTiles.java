...
public abstract class AshTiles extends BlockSlab {
	...
	public AshTiles(String name) {
		super(Material.ROCK);
		this.setRegistryName(name);
		this.setTranslationKey(Investiture.MODID + "." + name);
		this.setCreativeTab(Investiture.investitureTab);
	...
	public Item getItemDropped(IBlockState state, Random rand, int fortune) {
		return Item.getItemFromBlock(ModBlocks.ASH_TILES_HALF);
	}


	@Override
	public ItemStack getItem(World worldIn, BlockPos pos, IBlockState state) {
		return new ItemStack(ModBlocks.ASH_TILES_HALF);
	}
