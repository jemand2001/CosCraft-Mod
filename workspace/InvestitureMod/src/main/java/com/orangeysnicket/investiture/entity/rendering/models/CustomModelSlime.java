package com.orangeysnicket.investiture.entity.rendering.models;
...
public class CustomModelSlime extends ModelBase {
    ...
    public CustomModelSlime(int size)
    {
        if (size > 0)
        {
            this.slimeBodies = new ModelRenderer(this, 0, 0);
            this.slimeBodies.addBox(-3.0F * size, 17.0F * size, -3.0F * size, 6 * size, 6 * size, 6 * size);
